  ...
  var script = {
    ...
    methods: {
      ...
      getCaption: function getCaption() {
        ...
        var caption = this.selectedImage.name.replace(/\.[^/.]+$/, '');
      ...
      uploadFiles: function () {
        ...
        var loop = function ( i ) {
          ...
          var header_keys = Object.keys(p.uploadRequestHeaders);
          for (var i$1 = 0; i$1 < header_keys.length; i$1++) {
            var header = header_keys[i$1];
            var val = p.uploadRequestHeaders[header];
