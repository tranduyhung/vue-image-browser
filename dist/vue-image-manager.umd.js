              ...
              _vm.allowDelete
                ? _c(
                    "button",
                    {
                      ...
                      class: { loading: _vm.isDeleting },
                      attrs: { type: "button", disabled: _vm.isDeleting },
                      on: { click: _vm.deleteSelected }
                    },
                    [
                      _vm._v(
                        "\n        " +
                          _vm._s(_vm.langDeleteButtonLabel) +
                          "\n      "
                      )
                    ]
                  )
